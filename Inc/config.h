...
#define MOTOR_LEFT_ENA  1               // [-] Enable LEFT motor.  Comment-out if this motor is not needed to be operational
#define MOTOR_RIGHT_ENA 1               // [-] Enable RIGHT motor. Comment-out if this motor is not needed to be operational
...
#define N_MOT_MAX       850             // [rpm] Maximum motor speed limit
